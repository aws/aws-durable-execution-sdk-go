module github.com/aws/aws-durable-execution-sdk-go/insight
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/rdsdata v1.25.1
	github.com/aws/aws-sdk-go-v2/service/redshiftdata v1.37.1
