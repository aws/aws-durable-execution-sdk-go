// Command wait-for-callback-go is a minimal AWS Lambda custom runtime
// (provided.al2023-style container image) that runs a durable function
// demonstrating operations.WaitForCallback, using the AWS Durable
...
// and examples/run-in-child-context-go/main.go exactly (see either file's
...
// ExpenseEvent, ExpenseResult, and handler are defined in handler.go, kept
