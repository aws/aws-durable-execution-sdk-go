// Command wait-for-callback-nested-go is a minimal AWS Lambda custom
// runtime (provided.al2023-style container image) that runs a durable
// function demonstrating operations.WaitForCallback composed with
// operations.RunInChildContext, using the AWS Durable Execution SDK for
// Go. Implements the Lambda Runtime API directly against the standard
// library, mirroring examples/wait-for-callback-go/main.go exactly (see
// that file's doc comment for why: no network access to fetch
// aws-lambda-go or the AWS SDK for Go v2 in this development
// environment).
package main
...
// NestedCallbackEvent, NestedCallbackResult, and handler are defined in
