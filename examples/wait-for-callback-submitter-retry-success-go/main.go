// Command wait-for-callback-submitter-retry-success-go is a minimal AWS
// Lambda custom runtime (provided.al2023-style container image) that
// runs a durable function demonstrating a submitter that recovers after
// transient failures under
// operations.WithWaitForCallbackSubmitterRetryStrategy, using the AWS
...
// RetrySuccessEvent, RetrySuccessResult, and handler are defined in
