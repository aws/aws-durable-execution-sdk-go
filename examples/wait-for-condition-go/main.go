// Command wait-for-condition-go is a minimal AWS Lambda custom runtime
// (provided.al2023-style container image) that runs a durable function
// demonstrating operations.WaitForCondition, using the AWS Durable
...
// JobEvent, JobResult, and handler are defined in handler.go, kept
