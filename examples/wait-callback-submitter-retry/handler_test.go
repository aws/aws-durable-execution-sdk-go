...
func TestHandler(t *testing.T) {
	...
	// The handler's submitter calls the real Lambda API which is
	// unavailable in local testing. With RetryConfig MaxAttempts=4,
	// the submitter exhausts retries and the execution fails.
