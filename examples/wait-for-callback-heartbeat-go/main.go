// Command wait-for-callback-heartbeat-go is a minimal AWS Lambda custom
// runtime (provided.al2023-style container image) that runs a durable
// function demonstrating operations.WithWaitForCallbackHeartbeatTimeout,
...
// HeartbeatEvent, HeartbeatResult, and handler are defined in
