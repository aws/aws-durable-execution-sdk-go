// Command map-with-condition-and-callback-go is a minimal AWS Lambda
// custom runtime (provided.al2023-style container image) that runs a
// durable function using the AWS Durable Execution SDK for Go,
// implementing the Lambda Runtime API directly against the standard
// library (see the package doc below for why).
package main
...
// BatchEvent, BatchResult, and handler are defined in handler.go, kept
...
// resolution fails) - mirroring examples/large-payload-go's identical
