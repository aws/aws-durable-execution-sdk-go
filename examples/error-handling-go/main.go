// Command error-handling-go is a minimal AWS Lambda custom runtime
// (provided.al2023-style container image) that runs a durable function
// demonstrating the SDK's structured error hierarchy
// (pkg/durable/operations/errors.go), using the AWS Durable Execution SDK
...
// UnreliableChargeEvent, UnreliableChargeResult, and handler are defined
