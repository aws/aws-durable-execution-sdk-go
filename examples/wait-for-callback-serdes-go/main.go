// Command wait-for-callback-serdes-go is a minimal AWS Lambda custom
// runtime (provided.al2023-style container image) that runs a durable
// function demonstrating operations.WithWaitForCallbackSerdes, using
...
// TaskEvent, TaskResult, and handler are defined in handler.go, kept
// separate from this file's Lambda Runtime API plumbing so
